...
function assertEip712Transaction(transaction) {
  const { chainId, to, from: from9, paymaster, paymasterInput } = transaction;
  ...
  if (from9 && !isAddress(from9))
    throw new InvalidAddressError({ address: from9 });
...
function serializeTransactionEIP712(transaction) {
  const { chainId, gas, nonce, to, from: from9, value, maxFeePerGas, maxPriorityFeePerGas, customSignature, factoryDeps, paymaster, paymasterInput, gasPerPubdata, data } = transaction;
...
function transactionToMessage(transaction) {
  const { gas, nonce, to, from: from9, value, maxFeePerGas, maxPriorityFeePerGas, factoryDeps, paymaster, paymasterInput, gasPerPubdata, data } = transaction;
  return {
    txType: 113n,
    from: BigInt(from9),
    to: to ? BigInt(to) : 0n,
...
function serializeTransactionDeposit(transaction) {
  ...
  const { sourceHash, data, from: from9, gas, isSystemTx, mint: mint2, to, value } = transaction;
  const serializedTransaction = [
    sourceHash,
    from9,
    to ?? "0x",
...
function assertTransactionDeposit(transaction) {
  const { from: from9, to } = transaction;
  if (from9 && !isAddress(from9))
    throw new InvalidAddressError({ address: from9 });
  if (to && !isAddress(to))
    throw new InvalidAddressError({ address: to });
...
var datahavenTestnet = defineChain({
  id: 55931,
...
var etherlinkShadownetTestnet = defineChain({
  id: 127823,
...
var horizenTestnet = defineChain({
  id: 2651420,
...
var jasmyChainTestnet = defineChain({
  id: 681,
...
async function estimateFeesPerGas({ client, multiply, request, type: type2 }) {
  try {
...
var paseoPassetHub = defineChain({
  id: 420420422,
...
var reactiveTestnet = defineChain({
  id: 5318007,
...
var skaleBaseSepoliaTestnet = defineChain({
  id: 324705682,
...
function verify2(options) {
  ...
  return secp256r12.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex2(publicKey).substring(2), { lowS: true, ...hash2 ? { prehash: true } : {} });
}
...
var InvalidMajorTypeError = class extends BaseError2 {
...
var InvalidAdditionalInfoError = class extends BaseError2 {
...
var Unsupported64BitIntegerError = class extends BaseError2 {
  constructor() {
...
var UnsupportedTagError = class extends BaseError2 {
  constructor({ tag }) {
...
var InvalidIndefiniteLengthChunkError = class extends BaseError2 {
  constructor({ type: type2 }) {
    super(`Invalid chunk type in indefinite-length ${type2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
var InvalidSimpleValueError = class extends BaseError2 {
  constructor({ value }) {
...
var UnsupportedBigIntError = class extends BaseError2 {
  constructor() {
...
var UnexpectedTokenError = class extends BaseError2 {
  constructor({ token }) {
...
var NumberTooLargeError = class extends BaseError2 {
  constructor({ number }) {
...
var StringTooLargeError = class extends BaseError2 {
  constructor({ size: size2 }) {
    super(`String length exceeds maximum (4294967295): ${size2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
var ArrayTooLargeError = class extends BaseError2 {
  constructor({ size: size2 }) {
    super(`Array length exceeds maximum (4294967295): ${size2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
var ObjectTooLargeError = class extends BaseError2 {
  constructor({ size: size2 }) {
    super(`Object size exceeds maximum (4294967295): ${size2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
var ByteStringTooLargeError = class extends BaseError2 {
  constructor({ size: size2 }) {
    super(`Byte string length exceeds maximum (4294967295): ${size2}`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
(function(getEncodable2) {
  ...
  function string(value) {
    ...
    const size2 = encoded.length;
    if (size2 <= 23)
      return {
        length: 1 + size2,
        // 1 byte prefix + size bytes
        encode(cursor) {
          cursor.pushUint8(96 + size2);
          if (size2 > 0)
    ...
    if (size2 <= 4294967295)
      return {
        ...
        encode(cursor) {
          ...
          cursor.pushUint32(size2);
          cursor.pushBytes(encoded);
        }
      };
    throw new StringTooLargeError({ size: size2 });
  }
  ...
  function array(value) {
    ...
    throw new ArrayTooLargeError({ size: size2 });
  }
  getEncodable2.array = array;
  function byteString(value) {
    const size2 = value.byteLength;
    if (size2 <= 23)
      return {
        length: 1 + size2,
        // 1 byte prefix + size bytes
        encode(cursor) {
          cursor.pushUint8(64 + size2);
    ...
    throw new ByteStringTooLargeError({ size: size2 });
  }
  ...
  function object(value) {
    ...
    const size2 = keys.length;
    if (size2 <= 23)
      return {
        length: 1 + bodyLength,
        // 1 byte prefix + body length
        encode(cursor) {
          cursor.pushUint8(160 + size2);
    ...
    throw new ObjectTooLargeError({ size: size2 });
  }
...
function verify3(options) {
  ...
  if (rpId !== void 0) {
    ...
    const expectedRpIdHash = sha2563(fromString2(rpId), { as: "Bytes" });
...
var serializedKeychainV2Type = "0x04";
...
function extractAddress(options) {
  const { signature, root: root2 } = options;
...
function deserialize(value) {
  ...
  if (typeId === serializedWebAuthnType) {
    ...
    for (let split = 37; split < webauthnDataSize; split++) {
      const potentialJson = toString2(slice(webauthnData, split));
...
function from4(value) {
  ...
  return {
    ...
    ...type2 === "keychain" && !(typeof value === "object" && value !== null && "version" in value && value.version) ? { version: "v1" } : {},
    type: type2
  };
}
...
function serialize(envelope, options = {}) {
  ...
  if (type2 === "secp256k1") {
    const secp256k1 = envelope;
    return concat2(toHex4(secp256k1.signature), options.magic ? magicBytes : "0x");
  }
  if (type2 === "p256") {
    const p2563 = envelope;
  ...
  if (type2 === "keychain") {
    ...
    return concat2(keychainTypeId, keychain.userAddress, serialize(keychain.inner), options.magic ? magicBytes : "0x");
  }
  throw new CoercionError({ envelope });
}
...
function verify5(signature, parameters) {
  ...
  if (!address)
    return false;
  const envelope = from4(signature);
  if (envelope.type === "secp256k1") {
    if (!address)
      return false;
    return verify({
  ...
  if (envelope.type === "p256") {
    ...
    if (!isEqual2(envelopeAddress, address))
      return false;
    return verify2({
...
var CoercionError = class extends BaseError2 {
...
var VerificationError = class extends BaseError2 {
  constructor() {
    super(...arguments);
    Object.defineProperty(this, "name", {
      enumerable: true,
...
function from5(authorization, options = {}) {
...
function from6(authorization, options = {}) {
  ...
  if (options.signature)
    return {
      ...authorization,
      signature: from4(options.signature)
    };
  return authorization;
}
...
function fromTuple3(tuple) {
  ...
  const args = {
    address: keyId,
    expiry: typeof expiry !== "undefined" ? hexToNumber2(expiry) : void 0,
    type: keyType,
    chainId: chainId === "0x" ? 0n : toBigInt(chainId),
    ...typeof expiry !== "undefined" ? { expiry: hexToNumber2(expiry) } : {},
...
function toRpc4(authorization) {
  const { address, chainId, expiry, limits, type: type2, signature } = authorization;
  return {
...
function toTuple3(authorization) {
  ...
  const authorizationTuple = [
    ...
    typeof expiry === "number" || limitsValue ? numberToHex2(expiry ?? 0) : void 0,
    limitsValue
  ].filter(Boolean);
...
// node_modules/ox/_esm/core/Bech32m.js
...
var InvalidSerializedError2 = class extends BaseError2 {
...
function deserialize2(serialized) {
  ...
  if (feePayerSignatureOrSender !== "0x" && feePayerSignatureOrSender !== void 0) {
    if (feePayerSignatureOrSender === "0x00" || validate3(feePayerSignatureOrSender)) {
      ...
      if (validate3(feePayerSignatureOrSender))
  ...
  if (!transaction.from && signatureEnvelope) {
    try {
      transaction.from = extractAddress({
        payload: getSignPayload2(from8(transaction)),
        signature: signatureEnvelope,
        root: true
      });
    } catch {
...
function from8(envelope, options = {}) {
  ...
  return {
    ...envelope_,
    ...signature ? { signature: from4(signature) } : {},
    ...feePayerSignature ? { feePayerSignature: from2(feePayerSignature) } : {},
    type: "tempo"
  };
}
    ...
    if (options.format === "feePayer" && signature) {
      ...
      if (sig.type === "secp256k1")
        return recoverAddress({
          payload: getSignPayload2(from8(envelope)),
...
function getFeePayerSignPayload(envelope, options) {
  ...
  const serialized = serialize2({ ...envelope, signature: void 0 }, {
    sender,
    format: "feePayer"
  });
  return keccak256(serialized);
...
var CallsEmptyError = class extends BaseError2 {
  constructor() {
...
var InvalidValidityWindowError = class extends BaseError2 {
...
async function serialize3(transaction, signature) {
...
async function serializeTempo(transaction, sig) {
  ...
  if (signature && typeof transaction.feePayer === "object") {
    ...
    const hash2 = TxEnvelopeTempo_exports.getFeePayerSignPayload(tx, {
      sender
    });
    ...
    return TxEnvelopeTempo_exports.serialize(tx, {
      feePayerSignature: from2(feePayerSignature2)
    });
  }
  if (feePayer === true) {
    if (signature)
...
var chainConfig5 = {
  ...
  prepareTransactionRequest: [
    async (r, { phase }) => {
      ...
      if (phase === "afterFillParameters") {
        if (request.feePayer && request.keyAuthorization?.signature.type === "webAuthn")
  ...
  async verifyHash(client, parameters) {
    const { address, hash: hash2, signature } = parameters;
    if (typeof signature === "string" && signature.endsWith(SignatureEnvelope_exports.magicBytes.slice(2))) {
      const envelope = SignatureEnvelope_exports.deserialize(signature);
      if (envelope.type !== "keychain") {
        ...
        if (
          ...
          return SignatureEnvelope_exports.verify(envelope, {
            address,
            payload: hash2
          });
      }
...
// node_modules/viem/_esm/chains/definitions/tempoAndantino.js
var tempoAndantino = defineChain({
  ...chainConfig5,
  id: 42429,
  blockExplorers: {
    default: {
...
//# sourceMappingURL=chunk-HBROGEA3.js.map
