...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-BZVYYSQR.js");
  const signature_ = (() => {
...
var sha2564 = createHasher(() => new SHA2562());
var sha2242 = createHasher(() => new SHA2242());
...
function sha2566(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = sha2565(from(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
...
function numToSizedHex(num2, size4) {
  return bytesToHex2(numberToBytesBE(num2, size4));
}
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
var _2n3 = BigInt(2);
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b, from11, to2) => bytesToNumberBE(b.slice(from11, to2));
  class Signature {
...
var secp256k1_hasher = (() => createHasher2(secp256k12.ProjectivePoint, (scalars) => {
...
export {
  ...
  recoverPublicKey2 as recoverPublicKey,
  verify,
  verifyHash,
  AccountNotFoundError,
  AccountTypeNotSupportedError
};
//# sourceMappingURL=chunk-QAIYB4S6.js.map
